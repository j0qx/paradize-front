...
const BoardDatas = () => (
  ...
  <div className={style.boarddatas_container}>
    <div className={style.boarddatas_container__main}>
      <div className={style.boarddatas_container__main__percent}>
        <img className={style.boarddatas_container__main__percent__picture} src={percentgraph} alt="" />
